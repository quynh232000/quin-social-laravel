                                ...
                                <form wire:submit.prevent='creategroup' enctype="multipart/form-data">
                                    ...
                                    <div class="row ">
                                        <div class="col-ld-12 mb-3">
                                            <label for="" class="mont-font fw-600 font-xssss">Group icon</label>
                                    ...
                                    <div class="row ">
                                        <div class="col-12 mb-3">
                                            <div class="form-group">
                                                <label for="decription" class="mont-font fw-600 font-xssss">Group
                                                    Description</label>
