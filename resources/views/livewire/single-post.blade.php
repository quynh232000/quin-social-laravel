                ...
                <div class="col-xl-12 col-xxl-9 col-lg-12">
                    ...
                    <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                        <div class="card-body p-0 d-flex">
                            ...
                            <a href="{{route('user',$post->user->uuid)}}" class="fw-700 text-grey-900 font-xssss mt-1">{{ $post->user->first_name." ".$post->user->last_name }} <span
                            ...
                            <div class="dropdown-menu dropdown-menu-end p-4 rounded-xxl border-0 shadow-lg"
                                ...
                                <div class="card-body p-0 d-flex">
                                    <ul class="d-flex align-items-center justify-content-between mt-2">
                                        ...
                                        <li class="me-1"><a href="#" class="btn-round-lg bg-black text-white"><i class="fa-brands fa-github"></i></a></li>
                        ...
                        <form id="form-cmt" action="" method="post" class="my-2 position-relative "
                            ...
                            <button type="submit" class="outline-none ms-auto border-none bg-none position-absolute"
                                style="right: 1px;
                                top: 50%;
                    ...
                    <div class="card w-100 border-0 shadow-none right-scroll-bar">
                        ...
                        <div class="card-body border-top-xs pt-4 pb-3 pe-4 d-block ps-5">
                            <figure class=" position-absolute left-0 ms-2 mt-1"><img style="width: 35px;height:35px;object-git:cover;border-radius:50%" 
                                src="{{asset('storage/'.$user->profile)}}"
                                    alt="image" class="shadow-sm rounded-circle "></figure>
                            <div class="chat p-3 bg-greylight rounded-xxl d-block text-left theme-dark-bg">
                                <h4 class="fw-700 text-grey-900 font-xssss mt-0 mb-1">{{$user->first_name.' '.$user->last_name}}<a href="#"
                                        class="ms-auto"><i
                                            class="fa-solid fa-ellipsis-vertical float-right text-grey-800 font-xsss"></i></a></h4>
                                            <small class="fw-500 text-grey-500 lh-20 font-xssss w-100">{{$comment->updated_at->diffForHumans()  }}</small>
