                    ...
                    @forelse ($posts as $post)
                        <div class="card w-100 shadow-xss rounded-xxl border-0 p-4 mb-3">
                            <div class="card-body p-0 d-flex">
                                ...
                                <h4 class="fw-700 text-grey-900 font-xssss mt-1">{{ $post->user->first_name." ".$post->user->last_name }} <span
                            ...
                            <div class="card-body p-0 me-lg-5">
                                <a class="fw-500 text-grey-500" href="{{ route('single-post', ['useruuid'=>$post->user->uuid, 'postuuid'=>$post->uuid]) }}">
